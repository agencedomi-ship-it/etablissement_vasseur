...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Serrurier Vantory : artisan serrurier près de chez vous, 8h-22h et 24h/24 du vendredi au dimanche. Tarif annoncé, devis avant travaux, paiement après." },
      { name: "theme-color", content: "#1A2F4E" },
      { property: "og:title", content: "Serrurier Vantory — Un artisan près de chez vous" },
      { property: "og:description", content: "Mise en relation avec un artisan serrurier, 8h-22h et 24h/24 du vendredi au dimanche. Tarif annoncé, devis avant travaux, paiement après." },
