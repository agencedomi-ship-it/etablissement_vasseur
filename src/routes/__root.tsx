...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Serrurier Vantory : artisan serrurier près de chez vous. Lundi-jeudi 8h-22h, vendredi-dimanche 24h/24. Devis avant travaux, paiement après." },
      { name: "theme-color", content: "#1A2F4E" },
      { property: "og:title", content: "Serrurier Vantory — Un artisan près de chez vous" },
      { property: "og:description", content: "Mise en relation avec un artisan serrurier. Lundi-jeudi 8h-22h, vendredi-dimanche 24h/24. Devis avant travaux, paiement après." },
