...
export const Route = createRootRouteWithContext<MyRouterContext>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Dépannage serrurerie 7j/7 : un artisan serrurier partenaire chez vous en 20 minutes. Devis annoncé avant intervention, paiement après travaux, agréé par les assurances." },
      { name: "theme-color", content: "#1A2F4E" },
      { property: "og:title", content: "Ets Serrurier Vasseur — Devis annoncé, prix tenu" },
      { property: "og:description", content: "Un artisan serrurier partenaire chez vous en 20 minutes. Devis annoncé, paiement après travaux." },
